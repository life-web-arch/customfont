        ...
        <div style={{ ...S.card }}>
          ...
          <textarea key={previewKey} ref={previewRef} value={previewText}
            ...
            style={{ fontFamily:generatedFamily, fontSize:previewSize, lineHeight:1.45, width:'100%',
              minHeight: Math.max(180, previewSize * 1.45 * 3 + Math.max(20, previewSize * 1.03) + Math.max(14, previewSize * 0.25) + 8),
              background:'#fff', color:'#111', border:'1px solid var(--border)',
              borderRadius:8, paddingTop: Math.max(20, previewSize * 1.03), paddingBottom: Math.max(14, previewSize * 0.25), paddingLeft:14, paddingRight:14, resize:'none', overflow:'hidden',
